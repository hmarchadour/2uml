...
public class JDTVisitorTest {

	private JDTHandler mockedHandler;

	private JModelVisitor jdtVisitor;
	...
	public void setUp() throws Exception {
		mockedHandler = EasyMock.createMock(JDTHandler.class);
		jdtVisitor = CoreFactory.createJDTVisitor(mockedHandler);
	}

	public JDTVisitorTest(String testCaseName, Class<?> javaItemClass) {
