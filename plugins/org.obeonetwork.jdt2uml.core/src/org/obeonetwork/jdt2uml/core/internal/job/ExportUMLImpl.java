...
public class ExportUMLImpl implements UMLJob {
	...
	public ExportUMLImpl(String title, IJavaProject project, JDTCreatorHandler visitorHandler) {
		this.title = title;
	...
	public IStatus run(IProgressMonitor monitor) throws InterruptedException {
		...
		Factory.createJDTVisitor(visitorHandler).visit(getJavaProject());
