 ...
 *******************************************************************************/
package org.obeonetwork.jdt2uml.updator.api.job;
...
import org.obeonetwork.jdt2uml.updator.api.UpdatorFactory;
import org.obeonetwork.jdt2uml.updator.api.handler.JDTUpdatorHandler;
import org.obeonetwork.jdt2uml.updator.internal.job.UpdateUMLImpl;
			...
			if (resource != null) {
				...
				for (EObject eObject : contents) {
					if (eObject instanceof Model) {
						...
						JDTUpdatorHandler projectHandler = UpdatorFactory.createJDTModelUpdatorHandler(
								monitor, model);
