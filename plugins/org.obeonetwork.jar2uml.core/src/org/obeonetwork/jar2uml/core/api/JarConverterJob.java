...
public class JarConverterJob extends Job {
	...
	public JarConverterJob(IProject project, String fileName, Set<File> jarFiles) {
		super(JarConverterJob.class.getSimpleName());
